...
import { Download, Info, RotateCcw, Upload, XCircle } from 'lucide-react'
...
import type { IngestionSession, SessionDetail, SessionStatus } from './types'
...
export default function IngestionQueuePage() {
  usePageHeader(
    '인입 격리 큐',
    '업로드에 실패한 데이터를 확인하고 수정해 다시 처리합니다',
  )
        ...
        <div className="mt-4 flex flex-col gap-6 lg:flex-row">
          <div className="min-w-0 flex-1">
            ...
            <DataTable
              ...
              rowClassName={(s) =>
                s.id === activeId ? 'bg-surface-muted' : ''
              }
