...
export default function SubmissionsPage() {
  ...
  const headerBadges: {
    ...
    { label: `제출 ${counts.submitted}`, tone: 'info' },
    { label: `미제출 ${counts.notSubmitted}`, tone: 'neutral' },
    { label: `보완요청 ${counts.supplementRequested}`, tone: 'warning' },
    { label: `검토완료 ${counts.reviewDone}`, tone: 'success' },
    ...
    <div className="p-8">
      ...
      <div className="border-border bg-surface rounded-xl border p-6">
        <div className="flex flex-wrap items-center gap-3">
          <p className="text-fg text-xl font-bold">{data.assignmentTitle}</p>
          <button
            type="button"
              ...
              <div className="border-divider mt-4 border-t pt-5">
                {selected.status === 'not_submitted' ? (
                  ...
                  <>
                    ...
                    <p className="text-fg mt-5 text-sm font-bold">제출 URL</p>
                    {selected.url ? (
                      <a
                        href={selected.url}
                        target="_blank"
                    ...
                    <p className="text-fg mt-5 text-sm font-bold">제출 파일</p>
