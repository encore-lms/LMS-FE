...
export const RECOMMENDATION_ACTION_CAPTION =
  '제출 후 수정 불가 · 추천 없음은 사유 없이 제출 · 팀당 1명만 추천'
export const RECOMMENDATION_CONFIRM_EYEBROW = 'MENTOR RECOMMENDATION'
export const RECOMMENDATION_CONFIRM_TITLE = '추천 선택을 최종 제출할까요?'
export const RECOMMENDATION_CONFIRM_BODY =
  '추천 후보 1명 또는 추천 없음 선택을 최종 제출합니다. 제출 후 수정할 수 없습니다. 추천 대상자는 증명서용 간략 요약이 있어야 합니다.'
