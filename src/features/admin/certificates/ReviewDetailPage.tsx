...
import { AlertTriangle, ArrowLeft, Check, RotateCw, X } from 'lucide-react'
      ...
      <div className="border-border bg-surface mt-3 flex items-start justify-between gap-4 rounded-xl border p-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="mt-1 flex items-center gap-2">
              ...
              <span className="text-fg-subtle text-sm">{d.student.certId}</span>
            </div>
        ...
        {d.martStale && (
          <div className="bg-warning-bg text-warning rounded-lg px-3 py-2 text-right text-xs">
            ...
            <p className="mt-0.5">인증 요청 이후 갱신 안 됨 · 재계산 필요</p>
          </div>
        )}
      </div>
      ...
      <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-[1fr_340px]">
            ...
            <>
              ...
              <div className="mt-5">
                <div className="flex items-center justify-between">
                  <span className="text-fg text-sm font-bold">6축 점수</span>
                  <span className="text-fg-subtle text-xs">
                    평균 <span className="text-fg font-bold">{d.skillAvg}</span>{' '}
                    / 100
                  </span>
                </div>
        ...
        <div className="flex flex-col gap-4">
          <section className="border-border bg-surface rounded-xl border p-5">
            <div className="flex items-center justify-between">
              <span className="text-fg text-sm font-bold">승인 필수 체크</span>
              <span
                className={cn(
                  'text-sm font-bold',
