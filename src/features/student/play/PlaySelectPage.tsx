    ...
    <div className="flex flex-col gap-5 p-8">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        {data.games.map((g) => {
          ...
          return (
            <section key={g.key} className={cn(card, 'flex flex-col gap-3')}>
              <span
                className={cn(
              ...
              <span className="text-fg text-[16px] font-bold">{g.name}</span>
      ...
      <div className="flex flex-col gap-4 lg:flex-row">
        <section className={cn(card, 'flex flex-1 flex-col gap-3')}>
          <span className="text-fg text-[15px] font-bold">최근 게임 기록</span>
        ...
        <section className={cn(card, 'flex flex-col gap-3 lg:w-[320px]')}>
          <span className="text-fg text-[15px] font-bold">기수 랭킹 Top 5</span>
          {data.ranking.map((r) => (
